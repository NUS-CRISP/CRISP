...
import UpdateAssessmentGoogleForm from '../forms/UpdateAssessmentGoogleForm';

interface AssessmentGoogleOverviewProps {
  courseId: string;
...
const AssessmentGoogleOverview: React.FC<AssessmentGoogleOverviewProps> = ({
  courseId,
  assessment,
  sheetData,
...
export default AssessmentGoogleOverview;
