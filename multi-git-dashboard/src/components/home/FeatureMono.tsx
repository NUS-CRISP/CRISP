    ...
    return (
        <Box style={{ backgroundColor: 'black', width: '100%', padding: '0' }}>
            <Container className={classes.wrapper} size="lg">
                <Title className={classes.title} style={{ fontFamily: 'Verdana', color: 'white', marginBottom: '30px' }}>
                ...
                >
                    ...
                    <Box style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        <Text className={classes.description} style={{ fontFamily: 'Verdana', fontSize: '18px', color: 'white', textAlign: 'left' }}>
                            Managing <span style={{ color: '#3498db' }}>multiple GitHub repos in SWE courses </span>
                             is a headache... Or at least it used to be.
                            CRISP gives educators <span style={{ color: '#3498db' }}>real-time AI insights into student code, team progress, and project metrics with powerful GitHub visualization, with Jira and Trofos integration</span>. 
                            Teachers <span style={{ color: '#3498db' }}>assess</span> faster, students collaborate better - let CRISP transform your software engineering classroom!
                        </Text>
