...
const data = [
  { title: 'Where to reach us', description: 'crisp.nus.2024@gmail.com', icon: IconAt },
  { title: 'Where we\'re based', description: 'NUS School of Computing', icon: IconMapPin },
  { title: 'When we\'re available', description: '9 a.m. – 5 p.m.', icon: IconSun },
];
